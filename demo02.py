...
input_end_date = '2023-12-01 00:00:00'
timebin_minute = 5
...
print(ninjasat.df)
ninjasat.save_df_to_csv(ninjasat.df, "result/df_demo02.csv")
...
ninjasat.save_df_to_csv(ninjasat.result_df, "result/result_df_demo02.csv")
